    ...
    <table>
        <tbody>            
            <tr>
                ...
                <td>
                    <s:textfield name="chain" key="shaper.form.edit.chains" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="button" id="submitForm" onclick="newChain();" value="<s:property value="getText(\'shaper.form.new.chains.submit\')"/>" class="btn btn-large btn-primary"> 
                </td>
            </tr>
        </tbody>
    </table>       
